...
for i in range(1, 10):
    ...
    for imgPath in imgsPaths:
        ...
        # arr = extract_features.LVL(img_skeleton)
        # helpers.saveArrayToCSV(arr, "csv/lvl2.csv", str(i), appendCSV)
...
for i in range(1, 10):
    ...
    for imgPath in imgsPaths:
        ...
        # arr = extract_features.LVL(img_skeleton)
        # helpers.saveArrayToCSV(arr, "csv/lvl2_test.csv", str(i), appendCSV)
        appendCSV = True
